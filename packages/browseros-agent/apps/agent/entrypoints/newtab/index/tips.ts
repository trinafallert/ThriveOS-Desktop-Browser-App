...
export const TIPS: Tip[] = [
  ...
  {
    id: 'claude-code-mcp',
    text: 'Connect ThriveOS to Claude Code to control tabs, clicks, and pages from your terminal.',
  },
  {
    id: 'mcp-servers',
  ...
  {
    id: 'smart-nudges',
    text: 'If ThriveOS offers to connect an app, saying yes lets it use that app directly next time.',
  },
  {
    id: 'soul-md',
  ...
  {
    id: 'ad-blocking',
    text: 'ThriveOS supports uBlock Origin for ad blocking — install it from the Chrome Web Store or GitHub.',
  },
  {
    id: 'at-mention-tabs',
