...
import { useAgentServerUrl } from '@/lib/browseros/useThriveOSProviders'
...
import { createDefaultThriveOSProvider } from '@/lib/llm-providers/storage'
  ...
  const {
    ...
    transport: new DefaultChatTransport({
      ...
      prepareSendMessagesRequest: async ({ messages }) => {
        ...
        const provider =
          selectedLlmProviderRef.current ?? createDefaultThriveOSProvider()
