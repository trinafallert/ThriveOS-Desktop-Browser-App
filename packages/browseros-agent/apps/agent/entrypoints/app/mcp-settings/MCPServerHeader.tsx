...
const DOCS_URL = 'https://docs.thriveos.app/features/use-with-claude-code'

export const MCPServerHeader: FC<MCPServerHeaderProps> = ({
  serverUrl,
  isLoading,
  error,
  title = 'ThriveOS MCP Server',
  description = 'Connect ThriveOS to MCP clients like claude code, gemini and others.',
