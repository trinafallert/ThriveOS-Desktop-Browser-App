...
const primarySettingsSections: NavSection[] = [
  {
    ...
    items: [
      { name: 'ThriveOS AI', to: '/settings/ai', icon: Bot },
      {
        name: 'Chat Provider',
        to: '/settings/chat',
        icon: MessageSquare,
  ...
  },
  {
    ...
    items: [
      {
        name: 'Customize ThriveOS',
        to: '/settings/customization',
        icon: Palette,
        feature: Feature.CUSTOMIZATION_SUPPORT,
      },
      { name: 'ThriveOS as MCP', to: '/settings/mcp', icon: Server },
      {
        name: 'Usage & Billing',
        to: '/settings/usage',
        icon: CreditCard,
...
const helpItems: NavItem[] = [
  { name: 'Docs', href: 'https://docs.thriveos.app/', icon: BookOpen },
