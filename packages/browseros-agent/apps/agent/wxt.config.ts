...
export default defineConfig({
  ...
  manifest: {
    ...
    update_url: 'https://cdn.thriveos.app/extensions/update-manifest.xml',
    // update_url: 'https://cdn.thriveos.app/extensions/update-manifest.alpha.xml',
