#!/usr/bin/env python3
"""OTA CLI - Over-The-Air update automation for ThriveOS"""
...
server_app = typer.Typer(
    help="ThriveOS Server OTA commands",
    pretty_exceptions_enable=False,
    pretty_exceptions_show_locals=False,
)
...
def server_release(
    ...
    """Release ThriveOS Server OTA update
    ...
    """
    log_info(f"🚀 ThriveOS Server OTA v{version}")
    log_info("=" * 70)
...
def server_release_appcast(
    ...
    if upload_file_to_r2(r2_client, source_path, r2_key, env.r2_bucket):
        cdn_url = f"https://cdn.thriveos.app/{r2_key}"
...
def main(ctx: typer.Context):
    """OTA update automation for ThriveOS
