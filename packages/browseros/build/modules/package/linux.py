#!/usr/bin/env python3
"""Linux packaging module for ThriveOS (AppImage and .deb)"""
...
def copy_browser_files(
    ...
    dirs_to_copy = ["locales", "MEIPreload", "ThriveOSServer"]
...
Recommends: apparmor
Maintainer: ThriveOS Team <support@thriveos.app>
Homepage: https://www.thriveos.app/
Description: ThriveOS - The open source agentic browser
 ThriveOS is a privacy-focused web browser built on Chromium,
...
# Post-installation script for ThriveOS
set -e
...
# Pre-removal script for ThriveOS
set -e
...
def create_apparmor_profile(ctx: Context, apparmor_dir: Path) -> None:
    ...
    profile_content = f"""# AppArmor profile for ThriveOS
...
def create_metainfo_file(ctx: Context, metainfo_dir: Path) -> None:
    ...
    and other AppStream-aware tools can display ThriveOS in their catalogs.
    """
...
<component type="desktop-application">
  ...
  <url type="homepage">https://www.thriveos.app/</url>
  <url type="bugtracker">https://github.com/browseros-ai/ThriveOS/issues</url>
  <url type="help">https://docs.thriveos.app/</url>
  <description>
    <p>
      ThriveOS is a privacy-focused web browser built on Chromium,
      designed for modern web browsing with AI capabilities.
