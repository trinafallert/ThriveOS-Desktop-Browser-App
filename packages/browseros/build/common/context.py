...
class ArtifactRegistry:
    ...
    Example:
        ...
        artifacts.add("built_app", Path("/path/to/ThriveOS.app"))
...
class BuildConfig:
    ...
    def __init__(
        ...
        self.BROWSEROS_APP_BASE_NAME = "ThriveOS"
...
class Context:
    ...
    BROWSEROS_APP_BASE_NAME: str = "ThriveOS"  # Base name without extension
    ...
    def get_extensions_manifest_url(self) -> str:
        ...
        # return "https://cdn.thriveos.app/extensions/update-manifest.xml"
        return "https://cdn.thriveos.app/extensions/update-manifest.alpha.xml"
    ...
    def get_app_path(self) -> Path:
        ...
        For universal builds, checks if out/Default_universal/ThriveOS.app exists
    ...
    def get_artifact_name(self, artifact_type: str) -> str:
        ...
        Returns:
            Standardized filename, e.g., "ThriveOS_v0.31.0_arm64.dmg"
        """
        if not self.semantic_version:
