...
+
+/**
+ * @fileoverview 'settings-browseros-prefs-page' contains ThriveOS-specific settings.
+ */
+
...
+}
+
+export interface SettingsThriveOSPrefsPageElement {
+  $: {
+    addProviderDialog: HTMLElement;
+  };
+}
+
+const SettingsThriveOSPrefsPageElementBase = PrefsMixin(PolymerElement);
+
+export class SettingsThriveOSPrefsPageElement extends SettingsThriveOSPrefsPageElementBase {
+  static get is() {
...
+    'settings-browseros-prefs-page': SettingsThriveOSPrefsPageElement;
+  }
+}
+
+customElements.define(
+    SettingsThriveOSPrefsPageElement.is, SettingsThriveOSPrefsPageElement);
