...
const BROWSEROS_BINARY = '/Applications/ThriveOS.app/Contents/MacOS/ThriveOS'
...
Modes:
  --watch     Hot reload mode — wxt launches ThriveOS with HMR, server starts after CDP is ready
  --manual    Manual mode — launches ThriveOS directly, builds both extensions, no HMR
...
function startManualBrowser(ports: Ports): ReturnType<typeof spawn> {
  ...
  log('browser', `Launching ThriveOS...`)
