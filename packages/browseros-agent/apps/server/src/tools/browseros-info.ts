...
const BROWSEROS_INFO = `# ThriveOS — The Open-Source AI Browser

ThriveOS is an AI-native browser built on Chromium that turns plain English into browser actions. It runs AI agents locally on your machine, keeping your data private. Open source under AGPL-3.0.

**Docs:** https://docs.thriveos.app/
...
Learn more: https://docs.thriveos.app/features/bring-your-own-llm
...
Learn more: https://docs.thriveos.app/features/workflows

### Scheduled Tasks
Automate tasks on a schedule — daily, hourly, or every few minutes. Runs in a background window without interrupting your work. Use cases: morning briefings, LinkedIn automation, price monitoring. Requires ThriveOS to be open.
Learn more: https://docs.thriveos.app/features/scheduled-tasks
...
Learn more: https://docs.thriveos.app/features/cowork
...
Learn more: https://docs.thriveos.app/features/connect-mcps
...
Learn more: https://docs.thriveos.app/features/use-with-claude-code
...
Learn more: https://docs.thriveos.app/features/llm-chat-hub
...
Learn more: https://docs.thriveos.app/features/ad-blocking`
...
const TOPIC_SECTIONS: Record<string, { start: string; end?: string }> = {
  overview: { start: '# ThriveOS', end: '## Core Features' },
  'bring-your-own-llm': {
...
export const browseros_info = defineTool({
  name: 'browseros_info',
  description:
    'Get information about ThriveOS features, capabilities, and documentation links. Use when users ask "What is ThriveOS?", "What can ThriveOS do?", or about specific features.',
  input: z.object({
    topic: z
      .enum(VALID_TOPICS)
      .optional()
