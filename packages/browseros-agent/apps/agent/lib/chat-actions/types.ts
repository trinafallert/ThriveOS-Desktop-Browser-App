...
/**
 * Action for ThriveOS chat/agent queries
 * @public
 */
export interface ThriveOSAction extends BaseChatAction {
  type: 'browseros'
  mode: 'chat' | 'agent'
  message: string
  tabs?: chrome.tabs.Tab[]
 ...
 * @public
 */
export type ChatAction = AITabAction | ThriveOSAction
...
/**
 * Helper to create a ThriveOS action
 * @public
 */
export const createThriveOSAction = (params: {
  mode: 'chat' | 'agent'
  message: string
  tabs?: chrome.tabs.Tab[]
}): ThriveOSAction => ({
