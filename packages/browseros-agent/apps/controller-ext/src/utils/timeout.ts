...
/**
 * Timeout configuration for Chrome API and ThriveOS operations.
...
export const CHROME_API_TIMEOUTS = {
  ...
  /** ThriveOS page actions (click, scroll, input, etc.) */
  BROWSEROS_ACTION: 10_000,

  /** Heavy ThriveOS operations (screenshot, snapshot, accessibility tree) */
