...
**ThriveOS Agent Chrome Extension** - This project contains the official chrome extension for ThriveOS Agent, enabling users to interact with the core functionalities of ThriveOS.
