...
import { ThriveOSIcon, ProviderIcon } from '@/lib/llm-providers/providerIcons'
        ...
        <p className="truncate text-muted-foreground text-sm">
          {isBuiltIn ? (
            kimiLaunch ? (
              ...
              <>
                ThriveOS-hosted model with strict rate limits.{' '}
                <a
                  href="https://docs.thriveos.app/features/bring-your-own-llm"
                  target="_blank"
