#!/usr/bin/env python3
"""String replacement module for ThriveOS build system"""
...
branding_replacements = [
    (
        ...
        r"The ThriveOS Authors. All rights reserved.",
    ),
    (
        r"Google LLC. All rights reserved.",
        r"The ThriveOS Authors. All rights reserved.",
    ),
    (r"The Chromium Authors", r"ThriveOS Software Inc"),
    (r"Google Chrome", r"ThriveOS"),
    (r"(Google)(?! Play)", r"ThriveOS"),
    (r"Chromium", r"ThriveOS"),
    (r"Chrome", r"ThriveOS"),
]
