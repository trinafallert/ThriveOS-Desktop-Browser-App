...
const features: Feature[] = [
  ...
  },
  {
    ...
    Icon: Plug,
    tag: 'MCP',
    title: 'ThriveOS as MCP Server',
    description:
      'Connect Claude Code, Gemini CLI, or any MCP client to control your browser with 31 tools.',
    detailedDescription:
      'ThriveOS includes a built-in MCP server that lets AI coding agents control your browser. Claude Code can open tabs, click elements, fill forms, take screenshots, and read page content—all through natural language commands. Unlike Chrome DevTools MCP which requires debug profiles and separate servers, ThriveOS works out of the box. Just copy the URL from settings and connect.',
    highlights: [
          ...
          <div className="space-y-8 text-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                >
                  Watch our launch video to understand the vision of ThriveOS
                  and key features!
                </p>
              </div>
            </div>
            ...
            >
              <video
                ...
                title="ThriveOS MCP Server Demonstration"
                autoPlay
                muted
                loop
                playsInline
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-8 flex items-center gap-3">
            ...
            <h2 className="font-bold text-3xl">
              ...
              <span className="text-[var(--accent-orange)]">ThriveOS!</span>
            </h2>
          </div>
