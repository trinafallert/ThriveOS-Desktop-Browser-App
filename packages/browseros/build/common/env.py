#!/usr/bin/env python3
"""
Environment variable configuration for ThriveOS build system
...
class EnvConfig:
    ...
    def r2_cdn_base_url(self) -> str:
        """CDN base URL for R2 artifacts (default: http://cdn.thriveos.app)"""
        return os.environ.get("R2_CDN_BASE_URL", "http://cdn.thriveos.app")
