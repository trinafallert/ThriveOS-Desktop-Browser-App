#!/usr/bin/env python3
"""Upload module for ThriveOS build artifacts to Cloudflare R2"""
...
def _get_artifact_key(filename: str, platform: str) -> str:
    ...
    Examples:
        ThriveOS_v0.31.0_arm64.dmg -> arm64
        ThriveOS_v0.31.0_x64.dmg -> x64
        ThriveOS_v0.31.0_x64_installer.exe -> x64_installer
        ThriveOS_v0.31.0_x64.AppImage -> x64_appimage
