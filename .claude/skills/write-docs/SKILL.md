---
name: write-docs
description: Write ThriveOS feature documentation. Use when the user wants to create or update documentation for a ThriveOS feature. This skill explores the codebase to understand features and writes concise Mintlify MDX docs.
allowed-tools: Read, Grep, Glob, Bash, Task, Write, Edit
---

# Write ThriveOS Documentation

This skill helps write documentation for ThriveOS features. It follows a structured workflow to create high-quality, concise documentation pages.
...
- **Clear**: Write for first-time ThriveOS users
...
---
title: "Ad Blocking"
description: "ThriveOS blocks 10x more ads than Chrome out of the box"
---

ThriveOS ships with built-in ad blocking that works immediately—no extensions required.
...
1. ThriveOS MCP Server
2. Connecting other MCPs to ThriveOS assistant
3. Scheduled tasks
