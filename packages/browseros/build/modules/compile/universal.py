...
Design:
    ...
    Output: 3 DMGs uploaded:
        - ThriveOS_{version}_arm64_signed.dmg
        - ThriveOS_{version}_x64_signed.dmg
        - ThriveOS_{version}_universal_signed.dmg
...
class UniversalBuildModule(CommandModule):
    ...
    def execute(self, ctx: Context) -> None:
        ...
        for arch in UNIVERSAL_ARCHITECTURES:
            ...
            log_info(f"📍 ThriveOS: {arch_ctx.browseros_build_offset}")
        ...
        universal_app = ctx.chromium_src / "out/Default_universal/ThriveOS.app"
    ...
    def _merge_universal(
        ...
        universal_app = universal_dir / "ThriveOS.app"
