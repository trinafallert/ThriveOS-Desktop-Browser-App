#!/usr/bin/env python3
"""Windows signing module for ThriveOS"""
...
def get_browseros_server_binary_paths(build_output_dir: Path) -> List[Path]:
    """Return absolute paths to ThriveOS Server binaries for signing."""
    server_dir = build_output_dir / "ThriveOSServer" / "default" / "resources" / "bin"
