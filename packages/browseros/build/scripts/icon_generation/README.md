# ThriveOS Icon Generation

This directory contains the unified icon generation system for ThriveOS. All browser icons
...
3. **Build ThriveOS**: The `copy_resources.yaml` copies generated icons to chromium source tree
