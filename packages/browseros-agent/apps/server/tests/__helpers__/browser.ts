 ...
 *
 * Low-level ThriveOS process management.
 * Use setup.ts:ensureThriveOS() for the full test environment.
 */
...
export async function spawnBrowser(
  ...
  console.log(`Starting ThriveOS on CDP port ${config.cdpPort}...`)
  ...
  browserProcess.on('error', (error) => {
    console.error('Failed to start ThriveOS:', error)
  })
...
export async function killBrowser(): Promise<void> {
  ...
  console.log('Shutting down ThriveOS...')
