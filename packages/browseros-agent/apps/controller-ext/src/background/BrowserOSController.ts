...
import { CheckThriveOSAction } from '@/actions/diagnostics/CheckThriveOSAction'
 ...
 */
export class ThriveOSController {
  ...
  constructor(getPort: PortProvider) {
    logger.info('Initializing ThriveOS Controller...')
  ...
  async start(): Promise<void> {
    logger.info('Starting ThriveOS Controller...')
  ...
  stop(): void {
    logger.info('Stopping ThriveOS Controller...')
  ...
  private registerActions(): void {
    ...
    this.actionRegistry.register('checkThriveOS', new CheckThriveOSAction())
